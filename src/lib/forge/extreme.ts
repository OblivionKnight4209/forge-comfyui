...
export function writeMenus(): WriteMenu[] {
  ...
  return [
    ...
    { id: "kink", label: "Kinks", hint: "toys, play, fetish — pick several", surprise: "bdsm", items: NSFW_TYPES.filter((t) => t.id.startsWith("k-")) },
    { id: "pos", label: "Positions", hint: "every pose — pick several", surprise: "sex", items: g("Positions") },
    { id: "bdsm", label: "BDSM", hint: "rope, impact, cages — pick several", surprise: "bdsm", items: g("BDSM") },
